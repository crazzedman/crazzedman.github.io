...
public class Runner
{
    ...
    public static void main (String[]args) {
        ...
        javax.swing.JOptionPane.showMessageDialog(null,"Yoda: Do you want to play with the temperature?");
        ...
        int result = JOptionPane.showConfirmDialog(null,"Do you want Thermoagent to help you?", "Thermoagent",
            ...
            if(result == JOptionPane.YES_OPTION)
            {
                ...
                while(1==1)
                {
                   k = Environment.getInstance().simulate(k,a,false);
                   a = Environment.getInstance().returndt();
                }
            }
