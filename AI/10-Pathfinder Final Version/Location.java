...
public class Location implements Comparable<Location>
{
    ...
    public void addLink(Location A, int distance, int type)
    {
        if(!isLinked(A))
        {
            links.add(new Link(A,distance,type));
            tlinks.add(new Link(A, distance,type));
    ...
    public PriorityQueue<Link> getLinks()
    {
        return links;
    }
    public int getSLD()
