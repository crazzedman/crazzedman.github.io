...
class vehicle2:
    ...
    def decide(self,mouselocation):
        if mouselocation[0]<=self.x+80 and mouselocation[0]>=self.x-80 and mouselocation[1]<=self.y+80 and mouselocation[1]>=self.y-80 :
                self.speed = 10
...
def runner():
    ...
    if line == '2b' :
        ...
        image = pygame.image.load("BRVehicle02a.jpg")
    if line == '3a' :
        lambo = vehicle3('a',400,20,5)
        image = pygame.image.load("BRVehicle03a.jpg").convert()
    if line == '3b' :
        lambo = vehicle3('b',400,20,5)
        image = pygame.image.load("BRVehicle03b.jpg").convert()
    control = mouse()
