            ...
            if(answer.equals("no"))
            {
                if(temp.left.toString().indexOf("?")<=0)
                {
                    ...
                    else if(answerv2.equals("no"))
                    {
                        ...
                        System.out.println("What makes your game unique from " + temp.left+"?" + "(jepoardy style)");
            ...
            else if(answer.equals("yes"))
            {
                if(temp.right.toString().indexOf("?")<=0)
                {
                    ...
                    else if(answerv2.equals("no"))
                    {
                        System.out.println("What is your game?");
                        String newgame = question.next();
                        System.out.println("What makes your game unique from " + temp.right+"?" + "(jepoardy style)");
